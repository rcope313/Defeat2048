...
public class PlayGameManual extends World {
    ...
    public PlayGameManual() {}

    public static void main (String[] args) {
        PlayGameManual g = new PlayGameManual();
    ...
    public WorldScene lastScene (String msg) {
        return this.makeScene()
                .placeImageXY(new TextImage(msg, 100, Color.BLACK), Square.SIDE_LENGTH * 3, Square.SIDE_LENGTH * 3);
    }
    ...
    public World onKeyEvent(String s) {
        ...
        PlayGameManual updatedPlayGameManual = new PlayGameManual();
        Game2048 updatedGame2048;

        if (s.equals("up")) {
            updatedGame2048 = this.getGame2048().handleUpEvent().getUpdatedGame2048();
            updatedPlayGameManual.setGame2048(updatedGame2048);
            return updatedPlayGameManual;
        }
        if (s.equals("down")) {
