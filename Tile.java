    ...
    static WorldImage tileImage(int value) {
        ...
        if (value == 2) {
            ...
            WorldImage nonBorder =
                    (new OverlayImage
                            (new TextImage(Integer.toString(value), Square.SIDE_LENGTH * .4, Color.black),
        ...
        if (value == 128 || value == 256) {
            ...
            WorldImage nonBorder =
                    (new OverlayImage
                            (new TextImage(Integer.toString(value), Square.SIDE_LENGTH * .35, Color.black),
                                    (new RectangleImage(Square.SIDE_LENGTH - 5,
                                            Square.SIDE_LENGTH - 5,
                                            OutlineMode.SOLID,
                                            Color.YELLOW))));
        ...
        if (value == 1024 || value == 2048) {
            ...
            WorldImage nonBorder =
                    (new OverlayImage
                            (new TextImage(Integer.toString(value), Square.SIDE_LENGTH * .3, Color.black),
                                    (new RectangleImage(Square.SIDE_LENGTH - 5,
                                            Square.SIDE_LENGTH - 5,
                                            OutlineMode.SOLID,
                                            Color.ORANGE))));
        ...
        if (value == 16384 ||
            ...
            WorldImage nonBorder =
                    (new OverlayImage
                            (new TextImage(Integer.toString(value), Square.SIDE_LENGTH * .2, Color.black),
                                    (new RectangleImage(Square.SIDE_LENGTH - 5,
                                            Square.SIDE_LENGTH - 5,
                                            OutlineMode.SOLID,
                                            Color.CYAN))));
