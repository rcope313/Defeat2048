...
//    Grid2048 b0, b1, bBase, bUp, bDown, bLeft, bRight;
...
//
//        b0 = new Grid2048(new Square[][]{rowEmpty0, rowEmpty1, rowEmpty2, rowEmpty3});
...
//
//        b1 = new Grid2048(new Square[][]{row0, row1, row2, row3});
...
//                new Tile(2, new Posn(3, 3))};
//
//        bBase = new Grid2048(new Square[][]{row0Base, row1Base, row2Base, row3Base});
...
//                new EmptySquare(new Posn(3, 3))};
//
//        bUp = new Grid2048(new Square[][]{row0Up, row1Up, row2Up, row3Up});
...
//
//        bDown = new Grid2048(new Square[][]{row0Down, row1Down, row2Down, row3Down});
...
//                new EmptySquare(new Posn(3, 3))};
//
//        bLeft = new Grid2048(new Square[][]{row0Left, row1Left, row2Left, row3Left});
...
//                new Tile(4, new Posn(3, 3))};
//
//        bRight = new Grid2048(new Square[][]{row0Right, row1Right, row2Right, row3Right});
...
//        this.initData();
//        Grid2048 emptyBoard = gh0.getGame2048().getGrid2048();
//        assertThat(gh0.getKeyEventUp().getUpdatedGame2048().getGrid2048()).isEqualTo(emptyBoard);
//        assertThat(gh0.getKeyEventUp().isTilesMoved()).isFalse();
//        assertThat(gh0.getKeyEventDown().getUpdatedGame2048().getGrid2048()).isEqualTo(emptyBoard);
//        assertThat(gh0.getKeyEventDown().isTilesMoved()).isFalse();
//        assertThat(gh0.getKeyEventLeft().getUpdatedGame2048().getGrid2048()).isEqualTo(emptyBoard);
//        assertThat(gh0.getKeyEventLeft().isTilesMoved()).isFalse();
//        assertThat(gh0.getKeyEventRight().getUpdatedGame2048().getGrid2048()).isEqualTo(emptyBoard);
//        assertThat(gh0.getKeyEventRight().isTilesMoved()).isFalse();
//
//        assertThat(ghBase.getKeyEventUp().getUpdatedGame2048().getGrid2048()).isEqualTo(bUp);
//        assertThat(ghBase.getKeyEventUp().isTilesMoved()).isTrue();
//        assertThat(ghBase.getKeyEventDown().getUpdatedGame2048().getGrid2048()).isEqualTo(bDown);
//        assertThat(ghBase.getKeyEventDown().isTilesMoved()).isTrue();
//        assertThat(ghBase.getKeyEventLeft().getUpdatedGame2048().getGrid2048()).isEqualTo(bLeft);
//        assertThat(ghBase.getKeyEventLeft().isTilesMoved()).isTrue();
//        assertThat(ghBase.getKeyEventRight().getUpdatedGame2048().getGrid2048()).isEqualTo(bRight);
